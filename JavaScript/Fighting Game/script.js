...
// ** Create the Player class which can create a player with all it's attributes and methods **sssssss
...
let player1 = new Player("Pronto", 100, 10);

let player2 = new Player("Sorin", 100, 10);
